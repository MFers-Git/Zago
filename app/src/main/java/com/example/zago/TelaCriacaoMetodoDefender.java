...
public class TelaCriacaoMetodoDefender extends Tela{
    ...
    public TelaCriacaoMetodoDefender(Context context, Posicao posicoes, Jogador jogador) {
    ...
    public void criarTela() {
        ...
        af.add(gi.criarImg("tela criacao variavel defesa.png"));
        ...
        CaixaTexto ctTitulo = new CaixaTexto(getContext(),getPosicoes().getP1().x-50 , 70,"Criação de método defender",70);
        ...
        valorAtaqueCampeao.setTexto("Def. campeão");
        ...
        valorDefesaOponente.setTexto("Atc. oponente");
        ...
        cJNomeVariavel = new Cartao(getContext(), x + 310, 80, 180, 180,"nome","defesa",Acao.CARTAOJOGADOR);
...
////////////////////////////////////////////////////////////
        ...
        cJNomeMetodo = new Cartao(getContext(), x + 310, 550, 180, 180,"nome metodo","defender",Acao.CARTAOJOGADOR);
        ...
        //botões
        Botao finalizar = new Botao(getContext(),getPosicoes().getP12().x + 100, getPosicoes().getP14().y+50,180,180,Acao.CONFIRMARCRIACAOMETODODEFENDER);
