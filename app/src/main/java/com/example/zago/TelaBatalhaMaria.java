...
public class TelaBatalhaMaria extends Tela{
    ...
    public TelaBatalhaMaria(Context context, Posicao posicoes, Jogador jogador) {
    ...
    public void criarTela() {
        ...
        af.add(gi.criarImg("fundos/fase maria.png"));
        ...
        //oponente
        oponente = new Maria(getContext(),0,0,10,1,60,1);
    ...
    public void premiacao() {
        ...
        if (cartao.getTipo().equals("fracionado")){
            getJogador().addCartaoValorFracionado(cartao);
        }
        if (cartao.getTipo().equals("nome metodo")){
            getJogador().addCartaoNomeMetodo(cartao);
        }
