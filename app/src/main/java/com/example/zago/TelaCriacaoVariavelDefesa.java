...
public class TelaCriacaoVariavelDefesa extends Tela{
    ...
    public TelaCriacaoVariavelDefesa(Context context, Posicao posicoes, Jogador jogador) {
    ...
    public void criarTela() {
        ...
        CaixaTexto ctTitulo = new CaixaTexto(getContext(),getPosicoes().getP1().x-140 , 70,"Criação de Variável Defesa (inteiro)",70);
        ...
        cJTipo = new Cartao(getContext(), x + 230, 80, 180, 180,"inteiros","short",Acao.CARTAOJOGADOR);
        ...
        cJNome = new Cartao(getContext(), x + 230, 330, 180, 180,"nome","defesa",Acao.CARTAOJOGADOR);
        ...
        cJValor = new Cartao(getContext(), x + 230, 820, 180, 180,"valor inteiro","5",Acao.CARTAOJOGADOR);
        ...
        Botao finalizar = new Botao(getContext(),getPosicoes().getP12().x + 100, getPosicoes().getP14().y,180,180,Acao.CONFIRMARCRIACAOVARIAVELDEFESA);
