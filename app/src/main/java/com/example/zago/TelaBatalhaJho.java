...
public class TelaBatalhaJho extends Tela{
    ...
    public TelaBatalhaJho(Context context, Posicao posicoes, Jogador jogador) {
    ...
    public void criarTela() {
        ...
        //oponente
        oponente = new Jho(getContext(),0,0,10,1,60,1);
