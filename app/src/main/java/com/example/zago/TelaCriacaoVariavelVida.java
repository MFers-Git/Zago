...
public class TelaCriacaoVariavelVida extends Tela{
    ...
    public TelaCriacaoVariavelVida(Context context, Posicao posicoes, Jogador jogador) {
    ...
    public void criarTela() {
        ...
        af.add(gi.criarImg("tela criacao variavel vida.png"));
        ...
        CaixaTexto ctTitulo = new CaixaTexto(getContext(),getPosicoes().getP1().x-140 , 70,"Criação de Variável Vida (fracionado)",70);
        ...
        cTTipo = new Cartao(getContext(), x+30, y, 180, 180,"double",null, Acao.CARTAOTELA);
        ...
        cJTipo = new Cartao(getContext(), x + 230, 80, 180, 180,"double","double",Acao.CARTAOJOGADOR);
        ...
        cJNome = new Cartao(getContext(), x + 230, 330, 180, 180,"nome","vida",Acao.CARTAOJOGADOR);
        ...
        cJValor = new Cartao(getContext(), x + 230, 820, 180, 180,"valor fracionado","99.0",Acao.CARTAOJOGADOR);
        ...
        Botao finalizar = new Botao(getContext(),getPosicoes().getP12().x + 100, getPosicoes().getP14().y,180,180,Acao.CONFIRMARCRIACAOVARIAVELVIDA);
