...
public class TelaCriacaoVariavelForca extends Tela{
    ...
    public TelaCriacaoVariavelForca(Context context, Posicao posicoes, Jogador jogador) {
    ...
    public void criarTela() {
        ...
        af.add(gi.criarImg("fundo criacao variavel forca.png"));
        ...
        CaixaTexto ctTitulo = new CaixaTexto(getContext(),getPosicoes().getP1().x-140 , 70,"Criação de Variável Força (inteiros)",70);
        ...
        botoes.add(cJTipo);
            ...
            cJNome = new Cartao(getContext(), x + 230, 330, 180, 180,"nome","forca",Acao.CARTAOJOGADOR);
        ...
        botoes.add(cJOperador);
            ...
            cJValor = new Cartao(getContext(), x + 230, 820, 180, 180,"valor inteiro","10",Acao.CARTAOJOGADOR);
        ...
        Botao finalizar = new Botao(getContext(),getPosicoes().getP12().x + 100, getPosicoes().getP14().y,180,180,Acao.CONFIRMARCRIACAOVARIAVELFORCA);
