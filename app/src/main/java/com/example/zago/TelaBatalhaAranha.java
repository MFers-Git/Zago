...
public class TelaBatalhaAranha extends Tela{
    ...
    public TelaBatalhaAranha(Context context, Posicao posicoes, Jogador jogador) {
    ...
    public void criarTela() {
        ...
        af.add(gi.criarImg("fundos/fase aranha.png"));
        ...
        //oponente
        oponente = new Aranha(getContext(),0,0,10,1,60,1);
    ...
    public void premiacao() {
        ...
        if (cartao.getTipo().equals("operador atribuicao")){
            getJogador().addCartaoOperadorAtribuicao(cartao);
        }
